...
namespace CsvHelper
{
	...
	public class CsvContext
    {
		...
		public CsvContext(ISerializer serializer)
		{
			Serializer = serializer;
			Configuration = serializer.Configuration as CsvConfiguration ?? throw new InvalidOperationException($"{nameof(ISerializer)}.{nameof(ISerializer.Configuration)} must be of type {nameof(CsvConfiguration)} to be used in the context.");
			Maps = new ClassMapCollection(this);
		}
